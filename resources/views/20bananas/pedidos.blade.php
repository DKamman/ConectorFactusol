        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center">
                ...
                <form class="flex items-center ml-5" action="{{ route('20bananas.pedidos.getdebug') }}" method="GET">
                    ...
                    <button type="submit" class="ml-4 px-2 py-1 rounded bg-yellow-400 text-white font-semibold hover:drop-shadow hover:ease-in-out hover:duration-300">GET</button>
                </form>
            </div>
        </div>
    </x-slot>
