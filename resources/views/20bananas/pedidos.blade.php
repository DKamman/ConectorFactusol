            ...
            <div class="flex items-center">
                ...
                <div id="myModal" class="my-modal">
                    <div class="my-modal-contents">
                        ...
                        <div class="content">
                            <p class="text-sm mb-1.5">Are you sure you want to POST the <strong>Pedidos</strong> data hereby overwriting the current data?</p>
                        </div>
                        <div class="buttons flex justify-end">
                            <a class="px-2 py-1 rounded bg-red-600 text-white font-semibold hover:drop-shadow hover:ease-in-out hover:duration-300" href="{{ route('20bananas.pedidos.post') }}">POST</a>
                        </div>
                    </div>
                </div>
            </div>
